...
namespace Baldini.Controls.Calendar
{
        ...
        : CalendarRenderer
    {
        ...
        /// <summary>
        /// Gets or sets theCalendarColorTable for this renderer
        /// </summary>
        ...
        public override void OnDrawDayOverflowStart(CalendarRendererDayEventArgs e)
        {
            using (GraphicsPath path = new GraphicsPath())
            {
                int top = e.Day.OverflowStartBounds.Top;
                int bot = e.Day.OverflowStartBounds.Bottom - e.Day.OverflowStartBounds.Height / 2;
                path.AddPolygon(new Point[] {
                    new Point(e.Day.OverflowStartBounds.Left, bot),
                    new Point(e.Day.OverflowStartBounds.Right, bot),
                    new Point(e.Day.OverflowStartBounds.Left + e.Day.OverflowEndBounds.Width / 2, top),
                });
